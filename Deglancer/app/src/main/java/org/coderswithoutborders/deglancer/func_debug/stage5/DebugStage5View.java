 ...
 */
public class DebugStage5View extends FrameLayout implements IDebugStage5View {
    ...
    public DebugStage5View(Context context) {
        super(context);
        init();
    }

    public DebugStage5View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DebugStage5View(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public DebugStage5View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
