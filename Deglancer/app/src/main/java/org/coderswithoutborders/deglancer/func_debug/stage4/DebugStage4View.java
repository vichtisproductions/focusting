 ...
 */
public class DebugStage4View extends FrameLayout implements IDebugStage4View {
    ...
    public DebugStage4View(Context context) {
        super(context);
        init();
    }

    public DebugStage4View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DebugStage4View(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public DebugStage4View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
